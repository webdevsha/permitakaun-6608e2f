        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-6xl font-serif font-bold text-foreground mb-6 tracking-tight leading-[1.1] animate-in fade-in slide-in-from-bottom-8 duration-700">
              ...
              <div className="flex flex-col sm:flex-row items-center lg:justify-start justify-center gap-4 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-200">
                <Link
                  href="/signup"
            ...
            {/* Right - TikTok Videos (desktop: staggered grid, mobile: side-by-side) */}
            <div className="grid grid-cols-2 gap-3 sm:gap-4 animate-in fade-in slide-in-from-right-8 duration-1000">
              ...
              <CardContent className="flex-1 space-y-6">
                <div className="text-center">
                  ...
                  <div className="flex items-center justify-center gap-2">
                    <span className="text-5xl font-bold tracking-tight">RM29</span>
