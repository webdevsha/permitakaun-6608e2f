-- ============================================================================
-- FIX: Restore Missing Organizers (Version 3 - Handle Auth Users)
-- ============================================================================
-- This version looks up existing auth users or creates proper records
...
DECLARE
    shafira_id UUID;
    kumim_id UUID;
    shafira_exists BOOLEAN;
    kumim_exists BOOLEAN;
BEGIN
    ...
    -- ============================================================================
    -- STEP 4: Insert organizers with correct IDs
    -- ============================================================================
